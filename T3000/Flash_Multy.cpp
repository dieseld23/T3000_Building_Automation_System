...
void CFlash_Multy::Initial_List()
{
    ...
    m_flash_multy_list.InsertColumn(FLASH_ITEM, _T("NUM"), 46, ListCtrlEx::CheckBox, LVCFMT_CENTER, ListCtrlEx::SortByDigit);
    m_flash_multy_list.InsertColumn(FLASH_SERIAL_NUMBER, _T("SN"), 103, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_ID, _T("Panel ID"), 92, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_PRODUCT_NAME, _T("Name"), 92, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_COM_PORT, _T("Com"), 46, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_flash_multy_list.InsertColumn(FLASH_BAUDRATE,_T("Baudrate"),46,ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_IPADDRESS, _T("IP"), 138, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_IPPORT, _T("Port"), 69, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_SUB_NOTE, _T("Is Sub"), 69, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_ONLINE, _T("Is Online"), 69, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    ...
    m_flash_multy_list.InsertColumn(FLASH_FILE_POSITION, _T("Hex Bin File"), 138, ListCtrlEx::Normal, LVCFMT_LEFT, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_CONFIG_FILE_POSITION, _T("Configuration file"), 138, ListCtrlEx::Normal, LVCFMT_LEFT, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_RESULTS, _T("Firmware Results"), 115, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_CONFIG_RESULTS, _T("Configuration Results"), 115, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_PRODUCT_ID, _T("PID"), 69, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
    m_flash_multy_list.InsertColumn(FLASH_FIRMWARE_VERSION, _T("FW Version"), 92, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
