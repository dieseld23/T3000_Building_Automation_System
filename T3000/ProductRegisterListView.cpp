...
void CProductRegisterListView::Initial_List(void)
{
	...
	m_register_list.InsertColumn(_NUM_ITEM, _T("Item"), 69, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_POLLYESNO, _T("Poll Y/N"), 92, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_NAME, _T("Bacnet Object Name"), 115, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_FUNCTION, _T("Modbus Variable Type"), 138, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_MODBUSADDRESS, _T("Modbus Address"), 138, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByDigit);
	m_register_list.InsertColumn(_NUM_LENGTH, _T("Length"), 138, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_VALUE, _T("Value"), 103, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_DATAFORMAT, _T("Data Format"), 103, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_BIT, _T("Bit #"), 92, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Low_Actual, _T("Low Actual"), 115, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_High_Actual, _T("High Actual"), 115, ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Low_Scale, _T("Low Scale"), 115, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_High_Scale, _T("High Scale"), 115, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_RW, _T("R/W"), 103, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_DEFAULT, _T("Default"), 103, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Bacnet_Type, _T("Bacnet Type"), 138, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Bacnet_Object_Description, _T("Bacnet Object Description"), 230, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_COV_Increment, _T("COV Increment"), 115, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Unit_Group, _T("Unit Group"), 115, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Unit_Value, _T("Unit Value"), 115, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Grouping_Y_N, _T("Grouping YES / NO"), 230, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Update_On_Reconnect, _T("Update On Reconnect"), 230, ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_register_list.InsertColumn(_NUM_Modbus_DESCRIPTION, _T("Register Description"), 230, ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
